...
```bash
git clone https://github.com/krabbypatty1031-blip/Comp3057_FinalProject_23222069.git
cd Musify
```
...
The project comes with pre-trained models for classification and melody generation.

**Included Models:**
*   `models/music_generator_final.keras` (Melody Generation)
*   `models/song_classification_model.keras` (Genre Classification)
*   `models/normalization_params.json` (Helper file)

**Optional / Generated Models:**
*   `models/gpt2_lyrics_backend/` (Lyrics Generation)
    *   *Note*: As mentioned in the "Important" section, this is generated by running the `Lyrics Generation/GPT2_Lyrics_Service.ipynb` notebook. If missing, the system uses a base model automatically.
